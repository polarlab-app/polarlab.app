    ...
    <div className="dashboard">
      ...
      <div className={selectionStyles.bar}>
        ...
        <div
          ...
          className={`${selectionStyles.item} ${
            selectedTab === 'roleLogs' ? selectionStyles.selected : ''
          }`}
        ...
        <div
          ...
          className={`${selectionStyles.item} ${
            selectedTab === 'emojiLogs' ? selectionStyles.selected : ''
          }`}
      ...
      <div className="dashboardwrapper">
        <div
          style={{ display: selectedTab === 'channelLogs' ? 'block' : 'none' }}
        >
          {data ? (
            <>
              ...
              <div className={styles.togglegroup}>
                <TextboxInput
                  ...
                  onChange={(e) =>
                    handleTextboxChange(e.target.id, e.target.value)
                  }
                />
              </div>
            </>
            ...
            <>
              <div className={styles.togglegroup}>
                <CheckboxInput
                  ...
                  onChange={(e) =>
                    handleCheckboxChange(e.target.id, e.target.value)
                  }
                />
              </div>
              <div className={styles.togglegroup}>
        ...
        <div
          style={{ display: selectedTab === 'messageLogs' ? 'block' : 'none' }}
        >
          {data ? (
            <>
              <div className={styles.togglegroup}>
        ...
        <div
          style={{ display: selectedTab === 'memberLogs' ? 'block' : 'none' }}
        >
          {data ? (
            <>
              <div className={styles.togglegroup}>
        ...
        <div
          style={{ display: selectedTab === 'emojiLogs' ? 'block' : 'none' }}
        >
          {data ? (
            <>
              <div className={styles.togglegroup}>
        ...
        <div
          style={{ display: selectedTab === 'serverLogs' ? 'block' : 'none' }}
        >
          {data ? (
            <>
              <div className={styles.togglegroup}>
