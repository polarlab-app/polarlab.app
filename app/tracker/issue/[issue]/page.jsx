...
import secondaryStyles from '../../../../src/css/tracker/list.module.css';

export default async function Page({ params }) {
    const issueId = await params.issue;

    const bugResponse = await fetch('https://localhost:3000/api/tracker/getbug', {
        method: 'POST',
        headers: {
    ...
    const bugJSON = await bugResponse.json();
    const issue = bugJSON.issue;
